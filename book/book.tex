...
\fancyhead[C]{%
  ...
  {\color{seal}\raisebox{1pt}{\tiny$\Diamond$}}\hspace{0.8em}%
  \leftmark%
  \hspace{0.8em}{\color{seal}\raisebox{1pt}{\tiny$\Diamond$}}%
}
\fancyfoot[C]{\bookserifthin\small\color{inkgray}\thepage}
...
\vspace*{6cm}
\begin{center}
  {\trueka\fontsize{20pt}{24pt}\selectfont\color{inkgray} 陈\,炳\,林\,回\,忆\,录}\\[1.2em]
  {\color{seal}\rule{2em}{0.3pt}}
\end{center}
\cleardoublepage
...
\begin{titlepage}
  \centering
  \vspace*{1.2cm}
  {\trueka\fontsize{14pt}{18pt}\selectfont\color{inkgray}\addfontfeatures{LetterSpace=80} 回忆录}\\[1.8cm]
  {\fontsize{56pt}{64pt}\selectfont\bfseries 陈\,炳\,林}\\[0.7cm]
  {\color{seal}\rule{4em}{0.5pt}}\\[0.5cm]
  {\bookserifthin\large\color{inkgray}一九四〇\,—\,二〇二六}\\[1.8cm]
  \redseal\\[1.6cm]
  {\trueka\small\color{inkgray}陈炳林\ 口述\quad 陈旭鹏\ 整理}
\end{titlepage}
...
\vspace*{\fill}
\begin{center}
  {\trueka\Large 陈\,炳\,林\,回\,忆\,录}\\[1em]
  {\trueka\small 陈炳林\ 口述\quad 陈旭鹏\ 整理}\\[1.8em]
  {\color{seal}\rule{4em}{0.4pt}}\\[1.6em]
  \redseal\\[2em]
  {\bookserifthin\footnotesize\color{inkgray}
    内部刊印\quad 非卖品\\[4pt]
    二〇二六年\\[2em]
